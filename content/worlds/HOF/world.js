...
export class Classroom extends World {
  ...
  async entered(welcome) {
    ...
    this.screencast.screenShareMesh.position = new BABYLON.Vector3(
      -0.04,
      1,
      1.2
    );
    this.screencast.screenShareMesh.rotation = new BABYLON.Vector3(
      0,
      Math.PI,
      0
    );
    this.screencast.videoMesh.position = new BABYLON.Vector3(0, 3, -0.4);
